...
data = mat73.loadmat(r"/home/users/jbi/Bachelorarbeit/Codebase/Netze/MIONet/gauss_P_v_IC_nl_data/gauss_P_v_IC_vvar_10k_4k_20x.mat")
...
def train_deeponet(config,model_id):
    # Modellverzeichnis
    model_dir = f"/home/users/jbi/Bachelorarbeit/Codebase/Netze/MIONet/gauss_P_v_IC_nl_models/Parameterstudien_vvar/P_v_IC_lin_V2/{model_id}"
...
for i, config in enumerate(configs):
    ...
    print(results[0])
    keys = results[0].keys()
    with open('/home/users/jbi/Bachelorarbeit/Codebase/Netze/MIONet/gauss_P_v_IC_nl_models/Parameterstudien_vvar/P_v_IC_lin_V2/train_results.csv', 'w', newline='') as output_file:
